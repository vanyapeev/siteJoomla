<?php
/**
* Community Builder (TM) cbqueryfield Spanish (Spain) language file Administration
* @version $Id:$
...
return	array(
// 7 language strings from file plug_cbqueryfield/cbqueryfield.xml
...
'GROUP_COLUMN_c96153'	=>	'Grupo de Columnas',
);
