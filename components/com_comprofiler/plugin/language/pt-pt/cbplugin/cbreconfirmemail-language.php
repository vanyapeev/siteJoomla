<?php
/**
* Community Builder (TM) cbreconfirmemail Portuguese (Portugal) language file Frontend
* @version $Id:$
...
'NOTIFICATION_96d008'	=>	'Notificação',
