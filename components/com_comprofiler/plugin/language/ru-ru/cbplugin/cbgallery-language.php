...
'ENABLE_OR_DISABLE_DISPLAY_OF_ALBUMS_c20c05'	=>	'Включение или отключение отображения альбомов.',
'ALBUMS_15bf55'	=>	'Альбомы',
'INPUT_THE_ITEM_BOX_WIDTH_IN_PIXELS_LEAVE_BLANK_FOR_a9ee27'	=>	'Введите ширину  окна в пикселях. Оставьте поле пустым для ширины 200 пикселов. Обратите внимание, что минимальная ширина 100 пикселов.',
'BOX_WIDTH_8d6b85'	=>	'Ширина окна',
'ENABLE_OR_DISABLE_CREATION_OF_ALBUMS_cfe7e6'	=>	'Включение или отключение создания альбомов.',
'CREATE_686e69'	=>	'Создать',
'SELECT_ALBUM_CREATE_ACCESS_ACCESS_DETERMINES_WHO_C_a7b5c0'	=>	'Выберите доступ для создания альбомов . Доступ определяет, кто может создавать альбомы. Модераторы освобождены от этой настройки.',
...
'PHOTOS_5daaf2'	=>	'Фото',
'ENABLE_OR_DISABLE_DOWNLOADING_OF_PHOTOS_6e0d64'	=>	'Включить или отключить загрузку фотографий.',
'DOWNLOAD_801ab2'	=>	'Скачать',
'ENABLE_OR_DISABLE_CREATION_OF_PHOTOS_d2a854'	=>	'Разрешить или запретить создание фотографий.',
