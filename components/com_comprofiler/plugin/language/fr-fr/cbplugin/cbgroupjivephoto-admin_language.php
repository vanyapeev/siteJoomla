<?php
/**
* Community Builder (TM) cbgroupjivephoto French (France) language file Administration
* @version $Id:$
...
'GROUP_ASCENDING_adc1b8'	=>	'Groupe croissant',
'GROUP_DESCENDING_936f67'	=>	'Groupe décroissant',
