<?php
/**
* Community Builder (TM) cbgallery French (France) language file Frontend
* @version $Id:$
...
'SELECT_TEMPLATE_TO_BE_USED_FOR_ALL_OF_CB_GALLERY_I_c47ff6'	=>	'Sélectionne le Template que vous utiliserez avec CB Gallery. Si le Template est incomplet, les fichiers manquants seront remplacer par ceux du Template utiliser par défaut. Les fichiers du Template se trouve dans le dossier : components/com_comprofiler/plugin/user/plug_cbgallery/templates/.',
'OPTIONALLY_ADD_A_CLASS_SUFFIX_TO_SURROUNDING_DIV_E_79b347'	=>	'Ajoute un suffixe de classe aux balises DIV de CB Gallery (optionnel).',
'ENABLE_OR_DISABLE_AUTOMATIC_DELETION_OF_ITEMS_WHEN_468e68'	=>	'Active ou désactive la suppression automatique des éléments quand un membre est supprimé.',
...
'LINK_97e7c9'	=>	'Lien',
'CHOOSE_IF_IMAGES_UPLOADED_SHOULD_ALWAYS_BE_RESAMPL_b7b0e2'	=>	'Choisissez si les images téléchargées doivent toujours être redimensionnées. Le redimensionnement renforce la sécurité mais les animations ne fonctionnement que si vous utilisez ImageMagick.',
'INPUT_THE_MAXIMUM_HEIGHT_IN_PIXELS_THAT_THE_IMAGE__e0ce78'	=>	'Entrez la hauteur maximum de redimensionnement de l\'image en pixels. ',
'INPUT_THE_MAXIMUM_WIDTH_IN_PIXELS_THAT_THE_IMAGE_W_75174f'	=>	'Entrez la largeur maximum de redimensionnement de l\'image en pixels.',
...
'INPUT_THE_MINIMUM_ITEM_FILE_SIZE_IN_KBS_fcd110'	=>	'Entrez la taille minimum des fichiers des éléments en KBs.',
'INPUT_THE_MAXIMUM_ITEM_FILE_SIZE_IN_KBS_SET_TO_0_F_8ff57c'	=>	'Entrez la taille maximum des fichiers des éléments en KBs. Mettre 0 pour aucune limite.',
...
'OPTIONALLY_INPUT_A_TITLE_IF_NO_TITLE_IS_PROVIDED_T_a49e71'	=>	'Saisissez un titre (optionnel). Par défaut, le titre portera le nom du fichier.',
'SELECT_THE_ALBUM_FOR_THIS_FILE_b74b56'	=>	'Select the album for this file.',
'OPTIONALLY_INPUT_A_DESCRIPTION_83fc3f'	=>	'Entrer une description (optionnelle).',
'DESCRIPTION_b5a7ad'	=>	'Description',
'NO_CHANGE_bb84f3'	=>	'Pas de changement',
'SELECT_THE_FILE_TO_UPLOAD_739b2a'	=>	'Sélectionner le fichier à télécharger.',
'FILE_MUST_BE_EXTS'	=>	'Your file must be of [extensions] type.',
'FILE_SHOULD_EXCEED_SIZE'	=>	'Votre fichier exéde le taille de [size]',
'FILE_SHOUND_NOT_EXCEED_SIZE'	=>	'Votre fichier ne doit pas exéder le taille de [size]',
'INPUT_THE_URL_TO_THE_FILE_TO_LINK_1ec2e8'	=>	'Saisissez une URL pour activer le lien.',
...
'TYPE_FAILED_TO_SAVE'	=>	'Sauvegarde [type] échouée! Erreur : [error]',
'GALLERY_NEW_TYPE_CREATED'	=>	'Galerie - [type] créé!',
...
'TYPE_SAVED_SUCCESSFULLY_AND_AWAITING_APPROVAL'	=>	'Sauvegarde [type] réussie. En attente d\'approbation!',
'TYPE_SAVED_SUCCESSFULLY'	=>	'Sauvegarde [type] réussie!',
...
'TYPE_STATE_FAILED_TO_SAVE'	=>	'L\'état de sauvegarde [type] a échoué! Erreur: [error]',
'TYPE_STATE_SAVED_SUCCESSFULLY'	=>	'L\'état de sauvegarde [type] a réussi!',
'NOTHING_TO_DELETE_aea31f'	=>	'Nothing to delete.',
'TYPE_FAILED_TO_DELETE'	=>	'Suppression [type] échouée! Erreur: [error]',
'TYPE_DELETED_SUCCESSFULLY'	=>	'Suppression [type] réussie!',
...
'OPTIONALLY_INPUT_A_TITLE_IF_NO_TITLE_IS_PROVIDED_T_72a8cd'	=>	'Saisissez un titre (optionnel). Si aucun titre n\'est saisi, la date sera affichée en tant que titre.',
...
'PHOTO_c03d53'	=>	'Photo',
'VIDEOS_554cfa'	=>	'Vidéos',
'VIDEO_34e2d1'	=>	'Vidéo',
'MUSIC_47dcbd'	=>	'Musique',
...
'FILE_LINK_INVALID_URL'	=>	'Lien URL invalide. Assurez vous que le lien existe!',
...
'FILE_FAILED_TO_UPLOAD'	=>	'Echec téléchargement du fichier [file] !',
...
'PENDING_APPROVAL_017e8b'	=>	'En attente d\'approbation',
...
'ARE_YOU_SURE_UNPUBLISH_TYPE'	=>	'Êtes vous sûr de vouloir dé-publier ces [type]? ',
