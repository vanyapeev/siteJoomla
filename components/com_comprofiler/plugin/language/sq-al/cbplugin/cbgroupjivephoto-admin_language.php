<?php
/**
* Community Builder (TM) cbgroupjivephoto Albanian (Albania) language file Administration
* @version $Id:$
...
'OWNER_ASCENDING_edd599'	=>	'Pronar në ulje',
'OWNER_DESCENDING_c27319'	=>	'Pronar në rritje',
