			...
			return this.each( function () {
				...
				cbtooltip.tooltip = cbtooltip.element.qtip({
					...
					style: {
						...
						classes: ( cbtooltip.settings.classes ? cbtooltip.settings.classes : '' ) + ( tooltipMenu ? ' qtip-menu' : '' ) + ( tooltipModal ? ' qtip-modal' : '' ) + ( tooltipDialog ? ' qtip-dialog' : '' ) + ( noWidth ? ' qtip-nowidth' : '' )
					},
					events: {
