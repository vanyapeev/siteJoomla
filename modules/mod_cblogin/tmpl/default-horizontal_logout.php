...
<form action="<?php echo $_CB_framework->viewUrl( 'logout', true, null, 'html', $secureForm ); ?>" method="post" id="login-form" class="cbLogoutForm">
	...
	<?php if ( $preLogoutText ) { ?>
		<span class="pretext <?php echo htmlspecialchars( $templateClass ); ?>"><?php echo $preLogoutText; ?></span>
	<?php } ?>
	<?php echo modCBLoginHelper::getPlugins( $params, $type, 'almostStart', 'span', 1 ); ?>
	<?php if ( (int) $params->get( 'greeting', 1 ) ) { ?>
		<span class="login-greeting <?php echo htmlspecialchars( $templateClass ); ?>"><?php echo $greetingText; ?></span>
		&nbsp;
	<?php } ?>
	...
	<?php if ( $postLogoutText ) { ?>
		<span class="posttext <?php echo htmlspecialchars( $templateClass ); ?>"><?php echo $postLogoutText; ?></span>
	<?php } ?>
