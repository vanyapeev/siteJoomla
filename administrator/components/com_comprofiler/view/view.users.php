...
class CBView_users {
	...
	public function emailUsers( $rows, $emailTo, $emailSubject, $emailBody, $emailAttach, $emailCC, $emailBCC, $emailFromName, $emailFromAddr, $emailReplyName, $emailReplyAddr, $emailsPerBatch, $emailsBatch, $emailPause, $simulationMode, $pluginRows ) {
		...
		$return					.=		'<div class="form-group cb_form_line clearfix">'
								...
								.			'<label class="control-label col-sm-3">' . CBTxt::Th( 'MASS_MAILER_ALSO_TO_LABEL', 'Email Also To' ) . '</label>'
								.			'<div class="cb_field col-sm-9">'
								.				'<div>'
								...
								.		'</div>'
								.		'<div class="form-group cb_form_line clearfix">'
								.			'<label class="control-label col-sm-3">' . CBTxt::Th( 'MASS_MAILER_CC_LABEL', 'Email CC' ) . '</label>'
								.			'<div class="cb_field col-sm-9">'
								.				'<div>'
								...
								.		'</div>'
								.		'<div class="form-group cb_form_line clearfix">'
								.			'<label class="control-label col-sm-3">' . CBTxt::Th( 'MASS_MAILER_BCC_LABEL', 'Email BCC' ) . '</label>'
								.			'<div class="cb_field col-sm-9">'
								.				'<div>'
								...
								.		'</div>'
								.		'<div class="form-group cb_form_line clearfix">'
								.			'<label class="control-label col-sm-3">' . CBTxt::Th( 'Substitutions for Subject, Message, Attachments, CC, and BCC' ) . '</label>'
								.			'<div class="cb_field col-sm-9">'
	...
	public function ajaxResults( $usernames, $emailSubject, $emailBody, $emailAttach, $emailCC, $emailBCC, $emailFromName, $emailFromAddr, $emailReplyName, $emailReplyAddr, $limitstart, $limit, $total, $errors ) {
		...
		if ( ! ( $total - ( $limitstart + $limit ) > 0 ) ) {
			$return			.=	'<div class="form-group cb_form_line clearfix">'
							...
							.	'</div>'
							.	'<div class="form-group cb_form_line clearfix">'
							.		'<label class="control-label col-sm-3">' . CBTxt::T( 'CC' ) . '</label>'
							.		'<div class="cb_field col-sm-9">'
							.			'<div>' . htmlspecialchars( $emailCC ) . '</div>'
							.		'</div>'
							.	'</div>'
							.	'<div class="form-group cb_form_line clearfix">'
							.		'<label class="control-label col-sm-3">' . CBTxt::T( 'BCC' ) . '</label>'
							.		'<div class="cb_field col-sm-9">'
