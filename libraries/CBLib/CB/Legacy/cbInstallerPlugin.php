...
class cbInstallerPlugin extends cbInstaller
{
	...
	function install( $fromDirectory = null, $InstallIntoDatabaseOnly = false )
	{
		...
		$THISCBVERSION			=	'2.1.3+build.2018.01.01.21.09.14.b5ac000a8';               // IMPORTANT: DO NOT CHANGE MANUALLY, but when changing version automatically here also change 2 times in CBLib.php, the 8 XML installation files and build.xml
