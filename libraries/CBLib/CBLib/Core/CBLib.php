...
define( 'CBLIB', '2.1.3' );	// IMPORTANT: when changing version here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just below
...
class CBLib
{
	protected static $THISCBVERSION		=	'2.1.3+build.2018.01.01.21.09.14.b5ac000a8';	 	// IMPORTANT: DO NOT CHANGE MANUALLY, but when changing version automatically here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just above
	/**
	 * @var Application
	 */
